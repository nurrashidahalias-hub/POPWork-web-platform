...
// Fetch feedback YOU received from others
$sql = "SELECT f.*, 
               a.application_id,
               ...
               reviewer.avg_rating as reviewer_avg_rating,
...
// Calculate stats
$total_feedback = $feedbacks->num_rows;
$five_star = 0;
$would_work_again_count = 0;

$feedbacks->data_seek(0); // Reset pointer
while ($fb = $feedbacks->fetch_assoc()) {
    if ($fb['rating'] == 5) $five_star++;
    if ($fb['would_work_again']) $would_work_again_count++;
}
$feedbacks->data_seek(0); // Reset again for display
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Feedback I Received | POP!Work</title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h1>⭐ Feedback I Received</h1>
            <p>See what others have said about you</p>
        </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <div class="stat-number"><?= $five_star; ?></div>
                <div class="stat-label">5-Star Reviews</div>
            </div>
            <div class="stat-card">
                <div class="stat-number"><?= $would_work_again_count; ?></div>
                <div class="stat-label">Would Work Again</div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="feedback-grid">
                ...
                <div class="feedback-card">
                    ...
                    <div class="feedback-header">
                        <?php if (!empty($fb['reviewer_photo'])): ?>
                            <img src="<?= htmlspecialchars($fb['reviewer_photo']); ?>" class="person-photo" alt="Profile">
                        <?php else: ?>
                    ...
                    <div class="rating-display">
                        <div class="overall-rating">
                            <div>
                                <div class="rating-label">Their Rating</div>
                    ...
                    <div class="feedback-comment">
                        <div class="comment-label">💬 Their Comment</div>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p>When others give you feedback, it will appear here.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
